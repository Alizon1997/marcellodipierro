    ...
    <section id="metodo" className="py-24 bg-brand-dark relative border-t border-brand-border overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-brand-text mb-6 tracking-tight">
            {language === 'it' ? "L'Ingegneria dietro il Meeting." : 'The Engineering Behind the Meeting.'}
          </h3>
          <p className="text-brand-muted max-w-2xl mx-auto text-lg leading-relaxed">
            {language === 'it'
              ...
              : 'No improvisation. A 4-phase protocol to turn a stranger into a qualified appointment.'}
          </p>
        </div>
          ...
          {t.MECHANISM_STEPS.map((step, idx) => (
            ...
            >
              ...
              <div className="bg-brand-surface border border-brand-border hover:border-brand-accent/50 rounded-2xl p-6 h-full transition-all duration-300 hover:shadow-glow hover:-translate-y-1 z-10 flex flex-col relative overflow-hidden">
                ...
                {/* Icon */}
                <div className="relative z-10 w-12 h-12 bg-brand-surfaceHighlight rounded-xl flex items-center justify-center text-brand-text group-hover:text-brand-text group-hover:bg-brand-accent transition-colors duration-300 shadow-inner border border-brand-border/50 mb-6">
                  <step.icon className="w-6 h-6" />
                </div>

                {/* Content */}
                <div className="relative z-10 flex-grow">
                  <h4 className="text-lg font-bold text-brand-text mb-3 group-hover:text-brand-accent transition-colors">
                    {step.title}
                  </h4>
