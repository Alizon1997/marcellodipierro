...
const Comparison: React.FC = () => {
    ...
    return (
        <section id="offerta" className="py-12 md:py-20 bg-brand-dark border-t border-brand-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end mb-8 md:mb-16">
                    ...
                    <div className="lg:col-span-5 h-40 sm:h-48 md:h-56 lg:h-64 flex items-end justify-center space-x-4 sm:space-x-6 md:space-x-8 pb-4 border-b border-brand-border relative">
                        ...
                        <div className="w-16 sm:w-20 md:w-24 flex flex-col justify-end h-full group">
                ...
                <div className="overflow-hidden rounded-2xl border border-brand-border shadow-2xl max-w-5xl mx-auto">
                    <div className="grid grid-cols-12 bg-brand-surfaceHighlight/50 text-[10px] sm:text-xs font-mono uppercase tracking-wider sm:tracking-widest text-brand-muted py-3 sm:py-4 px-3 sm:px-6 border-b border-brand-border">
                    ...
                    {t.COMPARISON_DATA.map((row, idx) => (
                        <div key={idx} className="grid grid-cols-12 py-4 sm:py-6 px-3 sm:px-6 border-b border-brand-border last:border-0 bg-brand-surface hover:bg-brand-surfaceHighlight/20 transition-colors items-center">
                            <div className="col-span-4 md:col-span-4 font-bold text-brand-text text-[11px] sm:text-sm md:text-base">{row.feature}</div>
                            <div className="col-span-4 md:col-span-4 text-center text-brand-muted text-[10px] sm:text-xs md:text-sm px-1 sm:px-2">
                                {row.traditional}
                            </div>
                            <div className="col-span-4 md:col-span-4 text-center font-bold text-brand-text text-[10px] sm:text-xs md:text-sm px-1 sm:px-2 border-l border-brand-border/30 md:border-0">
