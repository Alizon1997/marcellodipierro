...
const getSeoConfig = (lang: string): SectionSEO[] => [
  { id: 'hero', title: 'Storm X Digital | B2B Outbound Sales Engine', description: lang === 'it' ? 'Costruiamo la tua pipeline outbound in 120 giorni — 60+ meeting qualificati garantiti, zero rischio assunzioni.' : 'We build your outbound pipeline in 120 days — 60+ qualified meetings guaranteed, zero hiring risk.' },
  ...
  { id: 'processo', title: lang === 'it' ? 'Pilot 120 Giorni: Risk Free | Storm X Digital' : '120-Day Pilot: Risk Free | Storm X Digital', description: lang === 'it' ? 'Setup, Test, Scale. Un programma di validazione di 120 giorni per stressare il tuo mercato.' : 'Setup, Test, Scale. A 120-day validation program to stress-test your market.' },
